...
namespace FlightReservation.Controllers
{
    public class flightsController : Controller
    {
        ...
        public ActionResult SearchResult(FormCollection collection)
        {
           ...
           flight = flight.Where(s => s.Dtime.Year.Equals(date1.Year));




           // flight = flight.Where(s => SqlFunctions.DatePart("year", s.Dtime) == SqlFunctions.DatePart("year", date1));
            //flight = flight.Where(s => s.Dtime.Contains(collection.Get("dDate")));
